...
@section('content')
    <div class="flex items-center justify-center min-h-screen mb-8 mt-20">
        ...
        <form action="{{ route('jamaahumrah.update', $peserta->id) }}" method="POST" enctype="multipart/form-data" class="w-full">
            @csrf
            @method('PUT')
                    ...
                    <div class="grid grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <textarea name="jenis_perjalanan" readonly required
                                class="w-full h-[50px] bg-white text-sm px-2 py-1 border rounded-md mt-1 resize-none">Jamaah Umrah</textarea>
    ...
    <script>
        ...
        // Generate kode khusus perjalanan
