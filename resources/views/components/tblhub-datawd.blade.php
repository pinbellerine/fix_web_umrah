                            ...
                            <th scope="row"
                                ...
                                <div class="flex justify-center items-center">
                                    <input type="checkbox"
                                        ...
                                        data-id="{{ $wisatadomestik->id }}"
                                        data-nama="{{ $wisatadomestik->nama_peserta }}"
                                        data-jk="{{ $wisatadomestik->jenis_kelamin }}"
                                        data-nik="{{ $wisatadomestik->nik }}"
                                        data-foto="{{ asset('storage/' . $wisatadomestik->foto_peserta) }}">
                                </div>
                            </th>
                            <td class="px-6 py-4">
