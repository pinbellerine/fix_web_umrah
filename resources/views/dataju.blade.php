                    ...
                    <tbody>
                        @foreach ($umrah as $jamaahumrah)
                            <tr data-open-part class="bg-white hover:bg-gray-50 text-black text-center">
                                ...
                                <td class="px-6 py-4 text-center">
                                    <div class="flex justify-center items-center">
                                        {{ $jamaahumrah->created_at }}
                                    </div>
                                </td>
                                <td class="px-6 py-4 text-center">
                                    <div class="flex justify-center items-center">
                                        {{ $jamaahumrah->date_of_issued_perjalanan }}
                                    </div>
                                </td>
                                <td class="px-6 py-4 text-center">
                                    <div class="flex justify-center items-center">
                                        {{ $jamaahumrah->date_of_expiry_perjalanan }}
                                    </div>
                                </td>
                                <td class="px-6 py-4 text-center">
                                    <div class="flex justify-center items-center gap-4">
                                        ...
                                        <!-- Tombol Lihat -->
                                        <a href="{{route('dataumrah.view', $jamaahumrah->id)}}" class="text-blue-400 hover:text-blue-500">
                                            <i class="fa-solid fa-eye"></i>
                                        </a>

                                        <!-- Tombol Edit -->
                                        <a href="{{route('jamaahumrah.edit', $jamaahumrah->id)}}" class="text-yellow-500 hover:text-yellow-600">
