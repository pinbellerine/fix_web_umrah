            ...
            <div class="flex items-center flex-grow">
                ...
                <div class="bg-gray-100 py-4 pl-6 pr-11 rounded-tl-3xl flex items-center flex-grow"
                    ...
                    <div class="relative w-full">
                        ...
                        <!-- Input -->
                        <form id="searchForm" method="GET" action="{{ route('dashboard.datawl') }}">
                        ...
                        <tr data-open-part class="bg-white hover:bg-gray-50 text-black text-center">
                            ...
                            <td class="px-6 py-4 text-center">
                                ...
                                <div class="flex justify-center items-center gap-4">
                                    ...
                                    <!-- Tombol Hapus -->
                                    <button data-open-del data-id="{{ $wisataluarnegeri->id }}" type="button" class="text-red-500 hover:text-red-600">
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (confirmDeleteBtn) {
                confirmDeleteBtn.addEventListener('click', function() {
                    ...
                    fetch(`/wisataluarnegeri/${currentItemId}`, {
                        method: 'DELETE',
                        headers: {
