...
@section('content')
                ...
                <div class="relative mt-4 mx-2 px-10 py-8 mb-8 bg-[#EFF3F4] p-6 rounded-xl">
                    ...
                    <div class="grid grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <textarea placeholder="Rp" readonly name="nik" required
                        ...
                        <div>
                            ...
                            <div class="flex items-center text-sm gap-x-4 space-x-4 mt-2">
                                <label class="flex items-center">
                                    <input type="radio" checked disabled name="lunas" value="L" required
                                        class="mr-2">
                                    DP
                                </label>
                                <label class="flex items-center">
                            ...
                            <div class="flex items-center text-sm gap-x-4 space-x-4 mt-2">
                                <label class="flex items-center">
                                    <input type="radio" checked disabled name="jenis_kelamin" value="L" required
                                        class="mr-2">
                                    Lunas
                                </label>
                                <label class="flex items-center">
                                    <input type="radio" disabled name="jenis_kelamin" value="P" required
                                        class="mr-2">
                                    Belum Lunas
                                </label>
                            </div>
                            ...
                            <div class="w-full bg-white rounded-lg p-2 text-center relative">
                                ...
                                <label for="fileInput2"
                                    class="cursor-pointer flex flex-col items-center justify-center w-full h-[135px]"
                                    data-open-surat1>
                                    <div id="previewContainer2" class="flex flex-col items-center justify-center">
                                    </div>
                                    <img id="previewImage2" src="/images/foto.jpeg"
    ...
    <div id="surat1modal" class="fixed inset-0 bg-black bg-opacity-[90%] flex items-center justify-center h-screen hidden">
        <div class="rounded-lg top-10 flex shadow-xl relative p-4 max-h-screen">
            <!-- Tombol Close -->
            <button class="absolute top-4 right-6 text-white hover:text-gray-400 text-4xl font-bold"
                data-close-surat1>&times;</button>
