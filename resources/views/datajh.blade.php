                    ...
                    <tbody>
                        @foreach ($haji as $jamaahhaji)
                            <tr data-open-part class="bg-white hover:bg-gray-50 text-black text-center">
                                ...
                                <td class="px-6 py-4 text-center">
                                    <div class="flex justify-center items-center">
                                        {{ $jamaahhaji->created_at }}
                                    </div>
                                </td>
                                <td class="px-6 py-4 text-center">
                                    <div class="flex justify-center items-center">
                                        {{ $jamaahhaji->date_of_issued_perjalanan }}
                                    </div>
                                </td>
                                <td class="px-6 py-4 text-center">
                                    <div class="flex justify-center items-center">
                                        {{ $jamaahhaji->date_of_expiry_perjalanan }}
                                    </div>
                                </td>
                                <td class="px-6 py-4 text-center">
                                    <div class="flex justify-center items-center gap-4">
                                        ...
                                        <!-- Tombol Lihat -->
                                        <a href="{{route('datahaji.view', $jamaahhaji->id)}}" class="text-blue-400 hover:text-blue-500">
                                            <i class="fa-solid fa-eye"></i>
                                        </a>

                                        <!-- Tombol Edit -->
                                        <a href="{{route('jamaahhaji.edit', $jamaahhaji->id)}}" class="text-yellow-500 hover:text-yellow-600">
